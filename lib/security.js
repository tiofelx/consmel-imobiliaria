...
export async function blockIpAndAlert(ip, reason, source = 'system', metadata = {}) {
    ...
    // Whitelist de localhost APENAS em ambiente de desenvolvimento.
    // Em produção, qualquer IP normalizado para 127.0.0.1/::1 é tratado
    // como suspeito (potencial spoof de X-Forwarded-For ou loopback malicioso).
