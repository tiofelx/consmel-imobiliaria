...
export default function ContactModal({ isOpen, onClose }) {
  ...
  return (
    <div className="contact-modal-overlay open" onClick={onClose}>
      <div className="contact-modal-content open modal-lg" onClick={(e) => e.stopPropagation()}>
        <button className="contact-modal-close-btn" onClick={onClose} aria-label="Fechar">
          ...
          <div className="contact-grid-modal">
            ...
            <div className="contact-info">
              ...
              <div className="info-card">
                ...
                <div>
                  <h4>Endereço</h4>
                  <a href="https://maps.app.goo.gl/nff5XLV9hV6m9LWQ8" target="_blank" rel="noopener noreferrer">
                    R. Santa Gotardo da Silva, 121<br />Jardim Lhen Nicolau, Guaraci-SP<br />15420-354
                  </a>
                </div>
              </div>
              ...
              <div className="social-links-modal">
                <h4>Redes Sociais</h4>
                <div className="social-buttons-modal">
                  <a
